 ...
 */
 ...
 Sk.Debugger.prototype.check_breakpoints = function(filename, lineno, colno, globals, locals) {
     ...
     if (dbgHasOwnProperty(this.dbg_breakpoints, key) &&
         this.dbg_breakpoints[key].enabled === true) {
         var bp = null;
         if (dbgHasOwnProperty(this.tmp_breakpoints, key)) {
 ...
 Sk.Debugger.prototype.set_suspension = function(suspension) {
     var parent = null;
     if (!dbgHasOwnProperty(suspension, "filename") && suspension.child instanceof Sk.misceval.Suspension) {
